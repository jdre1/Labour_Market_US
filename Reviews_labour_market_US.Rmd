...
### plotting Walmart average review by City
```{r}
...
### plotting Top 5 companies with highetrs number of reviews
```{r}
...
### plotting Number of reviews for position "Data Scientist" by US state
```{r}
